...
async def on_message(message):
    ...
    bot_message = " ".join((replace_mention(word, message.guild.members)
    ...
    if message.channel.id == channel_id or mention in message.content:
        ...
        querystring = {
            ...
            "bot_name": "Kitten",
            "bot_gender": "Male",
            "bot_master": "Mikko#9600",
            "bot_age": "215",
            "bot_company": "Mikko Studios",
            "bot_location": "Mars",
            "bot_email": "idk",
            "bot_build": "Public",
            "bot_birth_year": "2056",
            "bot_birth_date": "69th Marsary, 2056",
            "bot_birth_place": "Mars",
            "bot_favorite_color": "Green",
            "name": message.author.name,
            "bot_favorite_book": "How to train a robot",
            "bot_favorit	e_band": "Python rock band",
            "bot_favorite_artist": "Pythoner",
