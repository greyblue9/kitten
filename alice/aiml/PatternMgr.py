...
class PatternMgr:
    ...
    def add(self, unpackableparam, template):
        """
            Add a [pattern/that/topic] tuple and its corresponding template
            to the node tree.
        """

        (pattern, that, topic) = unpackableparam
